    ...
    () => [
      {
        ...
        details: ["+974 3320 2409", "+974 3320 2409"],
      ...
      },
      {
        ...
        details: [
          language === "en" ? "Saturday - Thursday: 9AM - 9PM" : "السبت - الخميس: 9 صباحاً - 9 مساءً",
        ...
        <div className={styles.container}>
          ...
          <div className={styles.mapWrapper}>
            <div className={styles.mapPlaceholder}>
              ...
              <p className={styles.mapAddress}>Block 2, Shop No SYS 066, Block 21, Near Dragon Mart Al Sayer, Doha</p>
        ...
        <div className={styles.container}>
          <div className={styles.quickContactContent}>
            ...
            <div className={styles.quickContactButtons}>
              <button className={styles.phoneButton} onClick={() => window.open("tel:+97433202409", "_self")} type="button">
                <Phone size={20} />
                {language === "en" ? "Call Now" : "اتصل الآن"}
              </button>

              <button className={styles.whatsappButtonLarge} onClick={() => window.open("https://wa.me/97433202409", "_blank")} type="button">
